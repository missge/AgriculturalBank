            ...
            <div style={{height:this.state.container_height}}>
                <div id="party" class="showTab1" style={{display:this.props.partyData.showNewContact === false ? "block" : "none"}}>
                    <div class="main_contanier">
                        ...
                        <Form labelPosition="left" model={this.props.partyData.form} labelWidth="120" onSubmit={this.onSubmit.bind(this)}>
                                <div class="form_content_col">
                                    <ul class="form_content_row">
                                     <li class="form_lf">
                                            <Form.Item label="是否共同借款人">
                                                <Radio.Group value={this.props.partyData.form.isrel} onChange={this.onChange.bind(this, 'isrel')}>
                                        ...
                                        <li class="form_rt">
                                            <Form.Item label="关系人类型">
                                                <Radio.Group value={this.props.partyData.form.reltype} onChange={this.onChange.bind(this, 'reltype')}>
                                    ...
                                    <ul class="form_content_row">
                                        <li class="form_lf">
                                            <Form.Item label="文化程度">
                                                <Radio.Group value={this.props.partyData.form.edulevel} onChange={this.onChange.bind(this, 'edulevel')} appendix="更多"
                                            ...
                                            >
                                                ...
                                                visible={ this.state.selectDialogVisible }
                                                value={this.props.partyData.form.edulevel} multiple={false} onChange={(val)=>{
                                        ...
                                        <li class="form_rt">
                                            <Form.Item label="婚姻状况">
                                                <Radio.Group value={this.props.partyData.form.marrysta} onChange={this.onChange.bind(this, 'marrysta')}>
                                    ...
                                    <ul class="form_content_row">
                                        <li class="form_lf">
                                            <Form.Item label="手机号码">
                                                <Input  size="small" value={this.props.partyData.form.mobno} placeholder="请输入手机号" onChange={this.onChange.bind(this, 'mobno')}></Input>
                                            </Form.Item>
                                        </li>
                                        <li class="form_rt">
                                            <Form.Item label="本人年税后收入">
                                                <Input  size="small" value={this.props.partyData.form.myselfincpm}  placeholder="20万" onChange={this.onChange.bind(this, 'myselfincpm')}></Input>
                                            </Form.Item>
                                        </li>
                                     ...
                                     <ul class="form_content_row">
                                        <li class="form_lf">
                                            <Form.Item label="配偶年税后收入">
                                                <Input  size="small" value={this.props.partyData.form.parincpm}  placeholder="配偶年税后收入" onChange={this.onChange.bind(this, 'parincpm')}></Input>
                                            </Form.Item>
                                        </li>
                                        <li class="form_rt">
                                        </li>
                        ...
                        <div class="showTab2">
                            <Tabs activeName="1" onTabClick={(tab) => console.log(tab.props.name) }>
                                <Tabs.Pane label="基本信息" name="1">
                                    <Form labelPosition="left"  model={this.props.partyData.form} labelWidth="170" onSubmit={this.onSubmit.bind(this)}>
                                           <div class="form_content">
                                                <div class="form_lf">
                                                    <Form.Item label="国家">
                                                       <Input value={this.props.partyData.form.country} placeholder="" onChange={this.onChange.bind(this, 'country')}></Input>
                                                    </Form.Item>
                                                    <Form.Item label="性别">
                                                         <Radio.Group value={this.props.partyData.form.gender } onChange={this.onChange.bind(this, 'gender')}>
                                                            <Radio.Button style={{marginBottom:"0px"}} value="女" />
                                                            <Radio.Button style={{marginBottom:"0px"}} value="男" />
                                                        </Radio.Group>
                                                    </Form.Item>
                                                      <Form.Item label="出生日期">
                                                       <Input value={this.props.partyData.form.birthday} placeholder="" onChange={this.onChange.bind(this, 'birthday')}></Input>
                                                    </Form.Item>
                                                    <Form.Item label="户籍地址">
                                                       <Input value={this.props.partyData.form.hjdz} placeholder="" onChange={this.onChange.bind(this, 'hjdz')}></Input>
                                                    </Form.Item>
                                                    <Form.Item label="居住状况">
                                                        <Radio.Group value={this.props.partyData.form.housesta} onChange={this.onChange.bind(this, 'housesta')} appendix="更多"
                                                    ...
                                                    >
                                                        <Dialog.Body>
                                                            <SelectList ref ="liveRadio"
                                                                        visible={ this.state.selectDialog2Visible }
                                                                        value={this.props.partyData.form.housesta} multiple={false} onChange={(val)=>{
                                                    ...
                                                    <Form.Item label="本地居住年限">
                                                       <Input value={this.props.partyData.form.bdzjnx} placeholder={this.props.partyData.form.bdzjnx} onChange={this.onChange.bind(this, 'bdzjnx')}></Input>
                                                    </Form.Item>
                                                    
                                                    <Form.Item label="长期居住地城乡属性">
                                                     <Radio.Group value={this.props.partyData.form.addagrflag} onChange={this.onChange.bind(this, 'addagrflag')}>
                                                ...
                                                <div class="form_rt">
                                                    <Form.Item label="证件类型">
                                                       <Input value={this.props.partyData.form.certtype} placeholder="身份证" onChange={this.onChange.bind(this, 'certtype')}></Input>
                                                    </Form.Item>
                                                    <Form.Item label="是否长期有效">
                                                         <Radio.Group value={this.props.partyData.form.isLong} onChange={this.onChange.bind(this, 'isLong')}>
                                                            <Radio.Button style={{marginBottom:"0px"}} value="是" />
                                                            <Radio.Button style={{marginBottom:"0px"}} value="否" />
                                                        </Radio.Group>
                                                    </Form.Item>
                                                    <Form.Item label="证件有效终止日">
                                                       <Input value={this.props.partyData.form.isbirthday} placeholder="2022-05-11" onChange={this.onChange.bind(this, 'isbirthday')}></Input>
                                                    </Form.Item>
                                                    <Form.Item label="是否本地常住户口">
                                                         <Radio.Group value={this.props.partyData.form.isLocal} onChange={this.onChange.bind(this, 'isLocal')}>
                                                            <Radio.Button style={{marginBottom:"0px"}} value="是" />
                                                            <Radio.Button style={{marginBottom:"0px"}} value="否" />
                                                        </Radio.Group>
                                                    </Form.Item>
                                                     ...
                                                     <Form.Item label="是否农行员工">
                                                         <Radio.Group value={this.props.partyData.form.abcstuffflag} onChange={this.onChange.bind(this, 'form','abcstuffflag')}>
                                                            <Radio.Button style={{marginBottom:"0px"}} value="是" />
                                                            <Radio.Button style={{marginBottom:"0px"}} value="否" />
                                                        </Radio.Group>
                                                    </Form.Item>
                                                    <Form.Item label="是否私人银行客户">
                                                         <Radio.Group value={this.props.partyData.form.isyhzh} onChange={this.onChange.bind(this, 'isyhzh')}>
                                                            <Radio.Button style={{marginBottom:"0px"}} value="是" />
                                                            <Radio.Button style={{marginBottom:"0px"}} value="否" />
                                                        </Radio.Group>
                                                    </Form.Item>
                                                    <Form.Item label="人行涉农个人客户类别">
                                                     <Radio.Group value={this.props.partyData.form.perclienttype} onChange={this.onChange.bind(this, 'perclienttype')}>
                                                    ...
                                                    <Form.Item label="长期居住地地址">
                                                       <Input value={this.props.partyData.form.settleaddr} placeholder="" onChange={this.onChange.bind(this, 'settleaddr')}></Input>
                                                    </Form.Item>
                                                </div>
                                            </div>
                                    </Form>
                                           ...
                                           <div class="form_content">
                                                <div class="form_lf">
                                                    ...
                                                    <Form.Item label="单位全称">
                                                       <Input value={this.props.partyData.form.corpname} placeholder="" onChange={this.onChange.bind(this, 'corpname')}></Input>
                                                    </Form.Item>
                                                    <Form.Item label="单位地址">
                                                       <Input value={this.props.partyData.form.dwdz} placeholder="" onChange={this.onChange.bind(this, 'dwdz')}></Input>
                                                    </Form.Item>
                                                    <Form.Item label="职称" >
                                                         <Radio.Group value={this.props.partyData.form.title}  onChange={this.onChange.bind(this, 'title')}>
                                                     ...
                                                     <Form.Item label="单位固定电话">
                                                       <Input value={this.props.partyData.form.dwgddh} placeholder="" onChange={this.onChange.bind(this, 'dwgddh')}></Input>
                                                    </Form.Item>
                                                    <Form.Item label="单位国标行业分类 ">
                                                         <Radio.Group value={this.props.partyData.form.corpstdtype} onChange={this.onChange.bind(this, 'corpstdtype')}>
                                                            <Radio.Button style={{marginBottom:"0px"}} value="其他" />
                                                        </Radio.Group>
                                                    </Form.Item>
                                                     <Form.Item label="个人信贷对象">
                                                         <Radio.Group value={this.props.partyData.form.careertype} onChange={this.onChange.bind(this, 'careertype')}>
                                                ...
                                                <div class="form_rt">
                                                   <Form.Item label="单位性质">
                                                         <Radio.Group value={this.props.partyData.form.corpchar} onChange={this.onChange.bind(this, 'corpchar')} appendix="更多"
                                                        ...
                                                        >
                                                            <Dialog.Body>
                                                                <SelectList ref ="educationSL" 
                                                            visible={this.state.selectDialog3Visible}
                                                            value={this.props.partyData.form.corpchar} multiple={false} onChange={(val)=>{
                                                      ...
                                                      <Form.Item label="职务状况">
                                                         <Radio.Group value={this.props.partyData.form.dutysta} onChange={this.onChange.bind(this, 'dutysta')}>
                                                            <Radio.Button style={{marginBottom:"0px"}} value="其他" />
                                                        </Radio.Group>
                                                    </Form.Item>
                                                     <Form.Item label="职业经营类别">
                                                         <Radio.Group value={this.props.partyData.form.manageRadio} onChange={this.onChange.bind(this, 'manageRadio')}>
                                                            <Radio.Button style={{marginBottom:"0px"}} value="工薪供职" />
                                                        </Radio.Group>
                                                    </Form.Item>
                                                    <Form.Item label="国标职业分类">
                                                        <Radio.Group value={this.props.partyData.form.stdjobtype} onChange={this.onChange.bind(this, 'stdjobtype')}>
                                           ...
                                           <div class="form_content">
                                                <div class="form_lf">
                                                    <Form.Item label="资产合计">
                                                       <Input value={this.props.partyData.form.asssum} placeholder="" onChange={this.onChange.bind(this, 'asssum')}></Input>
                                                    </Form.Item>
                                                    <Form.Item label="家庭对外担保额">
                                                       <Input value={this.props.partyData.form.guaramt} placeholder="" onChange={this.onChange.bind(this, 'guaramt')}></Input>
                                                    </Form.Item>
                                                </div>
                                                <div class="form_rt">
                                                    <Form.Item label="负债合计">
                                                      <Input value={this.props.partyData.form.debtsum} placeholder="" onChange={this.onChange.bind(this, 'debtsum')}></Input>
                                                    </Form.Item>
                                                     <Form.Item label="家庭其他年收入">
                                                       <Input value={this.props.partyData.form.othincpm} placeholder="" onChange={this.onChange.bind(this, 'othincpm')}></Input>
                                                    </Form.Item>
                                                </div>
                                            </div>
                                             <div class="form_content" >
                                                <div class="form_lf" style={{paddingTop:"0px"}}>
                                                    <Form.Item label="本人年债务性支出">
                                                       <Input value={this.props.partyData.form.debtexpd} placeholder="" onChange={this.onChange.bind(this, 'debtexpd')}></Input>
                                                    </Form.Item>
                                             ...
                                             <div class="form_content">
                                                 <div class="form_lf" style={{paddingTop:"0px"}}>
                                                    <Form.Item label="配偶年债务性支出">
                                                       <Input value={this.props.partyData.form.pardebtexpd} placeholder="" onChange={this.onChange.bind(this, 'pardebtexpd')}></Input>
                                                    </Form.Item>
                                           ...
                                           <div class="form_content">
                                                <div class="form_lf">
                                                     <Form.Item label="通信地址">
                                                         <Radio.Group value={this.props.partyData.form.addr} onChange={this.onChange.bind(this, 'addr')}>
                                                    ...
                                                    <Form.Item label="固定电话">
                                                       <Input value={this.props.partyData.form.teliprefix} placeholder="" onChange={this.onChange.bind(this, 'teliprefix')}></Input>
                                                    </Form.Item>
                                                </div>
                                                <div class="form_rt">
                                               
                                                    <Form.Item label="电子邮箱">
                                                       <Input value={this.props.partyData.form.email} placeholder="" onChange={this.onChange.bind(this, 'email')}></Input>
                                                    </Form.Item>
