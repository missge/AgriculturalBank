                          ...
                          if (this.state.frontDisplay == "none") {
                            this.showImageViewer(this.state.frontImage, () => {
                              navigator.camera.getPicture((data) => {
                                ...
                                this.props.partyActions.updateFile("{\"fileDesp\":\"身份证图片\",\"groupId\":\"0101\",\"workId\":\"" + this.props.client.procsId + "\",\"uploadPageList\":[" + JSON.stringify(this.state.frontFile) + "]}",
                                  (successData) => {
                          ...
                          <img src={require("../../images/camera.png")} style={{display: this.state.frontDisplay}}
                               onClick={() => {
                                 ...
                                 navigator.camera.getPicture((data) => {
                                   ...
                                   this.state.frontFile.imageBase64 = data;
                                   this.props.partyActions.uploadFile("{\"fileDesp\":\"身份证图片\",\"groupId\":\"0101\",\"workId\":\"" + this.props.client.procsId + "\",\"uploadPageList\":[" + JSON.stringify(this.state.frontFile) + "]}",
                                     (successData) => {
                                       this.props.partyActions.loading(false);
                                       this.setState({
                          ...
                          if (this.state.backDisplay == "none") {
                            this.showImageViewer(this.state.backImage, () => {
                              navigator.camera.getPicture((data) => {
                                ...
                                this.props.partyActions.updateFile("{\"fileDesp\":\"身份证图片\",\"groupId\":\"0101\",\"workId\":\"" + this.props.client.procsId + "\",\"uploadPageList\":[" + JSON.stringify(this.state.backFile) + "]}",
                                  (successData) => {
                                    this.props.partyActions.loading(false);
                          ...
                          <img src={require("../../images/camera.png")} style={{display: this.state.backDisplay}}
                               onClick={() => {
                                 ...
                                 navigator.camera.getPicture((data) => {
                                   ...
                                   this.props.partyActions.uploadFile("{\"fileDesp\":\"身份证图片\",\"groupId\":\"0101\",\"workId\":\"" + this.props.client.procsId + "\",\"uploadPageList\":[" + JSON.stringify(this.state.backFile) + "]}",
                                     (successData) => {
                                       this.props.partyActions.loading(false);
                                       this.setState({backImage: "data:image/png;base64," + data, backDisplay: "none"});
                                       this.state.backDisplay = "none";
          ...
          <div class="main_contanier scrollauto">
            ...
            <div class="form_content">
              <ul class="addParty_box">
                {
                  this.props.partyData.partyDataList.map(item => {
                    return
                    <li onClick={() => {
                      //当前点击的id
                      // mmspc.bridge.get(function (data) {
