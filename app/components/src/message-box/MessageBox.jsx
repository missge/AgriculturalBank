...
export default class MessageBox extends Component {
  ...
  typeClass(): string {
    return this.props.type && typeMap[this.props.type] && `mmspc-icon-${ typeMap[this.props.type] }`;
  }
            ...
            <View show={visible}>
              <div className="el-message-box__wrapper">
                <div className="el-message-box">
                  {
                    title && (
                      <div className="el-message-box__header" style={{flexDirection:showClose?'row':'column'}}>
                      {!showClose && (<div className="el-message-box__header_deco"/>)}
                        <div className="el-message-box__title">{title}</div>
                        {
                          showClose && (
                            <button type="button" className="el-message-box__headerbtn" aria-label="Close" onClick={this.handleAction.bind(this, 'cancel')}>
                              <i className="el-message-box__close mmspc-icon-close" />
                            </button>
                          )
                        }
                      </div>
                  ...
                  <div className="el-message-box__btns">
                    ...
                    <View show={showConfirmButton}>
                      <Button className={this.classNames('el-button--primary', confirmButtonClass,showCancelButton && 'high-light')} onClick={this.handleAction.bind(this, 'confirm')}>{this.confirmButtonText()}</Button>
                    </View>
                  </div>
                </div>
              </div>
