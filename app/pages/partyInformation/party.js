          ...
          <div>
            {
              ...
              mmspc.bridge.get((data) => {
                ...
                this.props.partyActions.ishaveInformation(JSON.parse("{\"req_id\":" + "\"" + this.props.client.procsId + "\", \"isrel\":\"0\"}"), this.props.client.clientId);
                //this.props.partyActions.ishaveInformation(data, JSON.parse("{\"req_id\":\"dc01db22-a682-4fee-\", \"isrel\":\"0\"}"));
              })
            }
          </div>
          <div class="main_contanier">
            ...
            <div class="form_content">
                  ...
                  <ul class="img_box">
                    <li>
                      <div class="camera_box">
                        <img src={this.state.frontImage ? this.state.frontImage : frontImage} onClick={() => {
                          if (this.state.frontDisplay == "none") {
                            this.showImageViewer(this.state.frontImage, () => {
                                ...
                                this.props.partyActions.updateFile("{\"fileDesp\":\"关系人有效证件\",\"groupId\":\"020101\",\"workId\":\"" + this.props.client.procsId + "\",\"uploadPageList\":[" + JSON.stringify(this.state.frontFile) + "]}",
                                  (successData) => {
                                    this.props.partyActions.loading(false);
                              ...
                              }, "/" +this.props.client.procsId + "/关系人影像/关系人有效证件/020101001.jpg");
                            }, () => {
                        ...
                        <p>
                          <img src={require("../../images/camera.png")} style={{display: this.state.frontDisplay}}
                               onClick={() => {
                                   // eslint-disable-next-line
                                   mmspc.customCamera.openRectCamera((data) => {
                                   this.props.partyActions.loading(true);
                                   this.state.frontFile.imageBase64 = data;
                                   this.props.partyActions.uploadFile("{\"fileDesp\":\"关系人有效证件\",\"groupId\":\"020101\",\"workId\":\"" + this.props.client.procsId + "\",\"uploadPageList\":[" + JSON.stringify(this.state.frontFile) + "]}",
                                     (successData) => {
                                       this.props.partyActions.loading(false);
                                       this.setState({
                    ...
                    <li>
                      <div class="camera_box">
                        <img src={this.state.backImage ? this.state.backImage : backImage} onClick={() => {
                          if (this.state.backDisplay == "none") {
                            this.showImageViewer(this.state.backImage, () => {
                                ...
                                this.props.partyActions.updateFile("{\"fileDesp\":\"关系人有效证件\",\"groupId\":\"020101\",\"workId\":\"" + this.props.client.procsId + "\",\"uploadPageList\":[" + JSON.stringify(this.state.backFile) + "]}",
                                  (successData) => {
                                    this.props.partyActions.loading(false);
                              ...
                              }, "/" +this.props.client.procsId + "/关系人影像/关系人有效证件/020101002.jpg");
                            }, () => {
                        ...
                        <p>
                          <img src={require("../../images/camera.png")} style={{display: this.state.backDisplay}}
                               onClick={() => {
                                   // eslint-disable-next-line
                                   mmspc.customCamera.openRectCamera((data) => {
                                   this.state.backFile.imageBase64 = data;
                                   this.state.backFile.pageType = "png";
                                   // this.props.partyActions.uploadFile("{\"fileDesp\":\身份证图片\",\"groupId\":\"0101\",\"workId\":\""+this.props.client.procsId+"\",\"uploadPageList\":\"["+this.state.backFile+"]\"}");
                                   // this.props.partyActions.uploadFile("{\"fileDesp\":\"身份证图片\",\"groupId\":\"0101\",\"workId\":\"001802A5100000026\",\"uploadPageList\":["+JSON.stringify(this.state.backFile)+"]}");
                                   this.props.partyActions.uploadFile("{\"fileDesp\":\"关系人有效证件\",\"groupId\":\"020101\",\"workId\":\"" + this.props.client.procsId + "\",\"uploadPageList\":[" + JSON.stringify(this.state.backFile) + "]}",
                                     (successData) => {
                                       this.props.partyActions.loading(false);
                                       this.setState({backImage: "data:image/png;base64," + data, backDisplay: "none"});
                                       this.state.backDisplay = "none";
              ...
              <div class="three_box_rt">
                ...
                <div style={{display: !this.props.partyData.netCheck ? "inline" : "none"}}>
                  <Button type="primary" style={{height: 70, width: 70}} disabled={!this.state.netCheckState}
                          ...
                          onClick={() => {
                            if (reg.test(this.state.cardNumber) == false) {
                              ...
                              if (this.state.netCheckState) {
                                ...
                                this.props.partyActions.addCustomer("{\"cliname\":" + "\"" + this.state.cardName + "\",\"certno\":" + "\"" + this.state.cardNumber + "\" , \"req_id\":\"" + this.props.client.procsId + "\" , " +
                                  "\"self\":\"1\" , \"certtype\":\"110001\" , \"isrel\":\"1\"}");
                              } else {
                                this.setState({loadingContent: "联网核查...", fullscreen: true});
                           ...
                           onClick={() => {
                             if (this.state.showIdentityFinished == "none") {
                               ...
                               mmspc.customCamera.openRectCamera(successData => {
                                 ...
                                 alert('失败：' + errorData);
                               }, "/" + this.props.client.procsId + '/关系人影像/手持身份认证/010102002.jpg');
                             } else {
                                                ...
                                                <img class="lWhiteTabTitle" src={require("../../images/signature.png")}
                                                     ...
                                                     onClick={() => {
                                                       ...
                                                       mmspc.fileConversion.getAuthorizationLetter(msg => {
                                                         ...
                                                         this.props.partyActions.uploadFile("{\"fileDesp\":\"征信查询授权书\",\"groupId\":\"020102\",\"workId\":\"" + this.props.client.procsId + "\",\"uploadPageList\":[" + JSON.stringify(this.state.pageSign) + "]}",
                                                           (successData) => {
                                                             this.setState({
                          ...
                          /*判断是否已经纸质签名拍照，若已拍过，点击查看签名*/
                             onClick={() => {
                               ...
                               mmspc.customCamera.openRectCamera(successData => {
                                 ...
                                 this.setState({dialogVisible: false});
                                 this.props.partyActions.uploadFile("{\"fileDesp\":\"征信查询授权书\",\"groupId\":\"020102\",\"workId\":\"" + this.props.client.procsId + "\",\"uploadPageList\":[" + JSON.stringify(this.state.photoSign) + "]}",
                                   (successData) => {
                                     this.setState({
                                       showCreditFinished: "block",
                                       isShowPhotoSign: "photo"
                        ...
                        <div>
                          <Button type="warning" style={{height: 70, width: 70}} textStyle={{
                            ...
                            whiteSpace: 'normal'
                                  ...
                                  onClick={() => {
                                    this.props.partyActions.getCreditResult(JSON.parse("{\"req_id\":\"" + this.props.client.procsId + "\",\"clientId\":\"" + this.props.client.clientId + "\"}"));
            ...
            <div class="footer_content">
              ...
              <div class="footer_content_rt">
                <Button type="warning" size="large" onClick={() => {
                  ...
                  this.props.partyData.form.clientId = this.props.relate.relateId;
                  this.props.partyData.form.req_id = this.props.client.procsId;
                  this.props.partyActions.postPartyInfo(this.props.partyData.form);
                }}
                >新增关系人
                </Button>
              </div>
          ...
          <div class="main_contanier scrollauto">
            ...
            <div class="form_content">
              <ul class="addParty_box">
                <div>
                    {
                        Array.isArray(this.props.partyData.partyDataList)?this.props.partyData.partyDataList:[].map(item => {
                            return
                            <li onClick={() => {
                                //当前点击的id
                                // mmspc.bridge.get(function (data) {
              ...
              <Tabs.Pane label="基本信息" name="1">
                <Form labelPosition="left" model={this.props.partyData.form} labelWidth="170"
                  ...
                  <div class="form_content">
                    <div class="form_lf">
                      <Form.Item label="国家">
                        <Input value={this.props.partyData.form.country} placeholder="中国"
                      ...
                      <Form.Item label="性别">
                        <Radio.Group value={this.props.partyData.form.gender}
                          ...
                          <Radio.Button style={{marginBottom: "0px"}} value="男" disabled={true}/>
                        </Radio.Group>
                      </Form.Item>
                      <Form.Item label="出生日期">
                        <Input value={this.props.partyData.form.birthday} placeholder="2000.01.01"
                               onChange={this.onChange.bind(this, 'birthday')} disabled={true}></Input>
                      </Form.Item>
          ...
          <NavBar
            ...
            rClick={() => {
              ...
              if (this.state.isLookorAdd === 1) {
                this.props.partyActions.deleteRelated(JSON.parse("{\"clientId\":\"" + this.props.client.clientId + "\" , \"_method\":\"delete\"}"));
              }
            }
            }
          >
                            ...
                            onClick={() => {
                              if (reg.test(this.state.cardNumber) == false) {
                                ...
                                if (this.state.netCheckState) {
                                  ...
                                  this.props.partyActions.addCustomer("{\"cliname\":" + "\"" + this.state.cardName + "\",\"certno\":" + "\"" + this.state.cardNumber + "\" , " +
                                    "\"req_id\":\"" + this.props.client.procsId + "\" , \"self\":\"2\",\"certtype\":\"110001\"}");
                                                    ...
                                                    <img class="lWhiteTabTitle"
                                                         ...
                                                         onClick={() => {
                                                           ...
                                                           mmspc.fileConversion.getAuthorizationLetter(msg => {
                                                             ...
                                                             this.setState({dialogVisible: false});
                                                             //上传图片
                                                             this.props.partyActions.uploadFile("{\"fileDesp\":\"征信查询授权书\",\"groupId\":\"010102\",\"workId\":\"" + this.props.client.procsId + "\",\"uploadPageList\":[" + JSON.stringify(this.state.pageSign) + "]}",
                                                               (successData) => {
                                                                 this.setState({
                                                                   showCreditFinished: "block",
                                                                   isShowPhotoSign: "write"
                                                             ...
                                                             //上传征信授权书
                                                             this.props.partyActions.uploadCreditPage(this.props.client.procsId, this.props.client.clientId, "/" + this.props.client.procsId + '/借款人影像/征信查询授权书/010102001.jpg');
                                                           }, function (errorStr) {
                                                             alert(errorStr);
                              ...
                              /*判断是否已经纸质签名拍照，若已拍过，点击查看签名*/
                                 onClick={() => {
                                   ...
                                   mmspc.customCamera.openRectCamera(successData => {
                                     ...
                                     this.setState({dialogVisible: false});
                                     //上传图片
                                     this.props.partyActions.uploadFile("{\"fileDesp\":\"征信查询授权书\",\"groupId\":\"010102\",\"workId\":\"" + this.props.client.procsId + "\",\"uploadPageList\":[" + JSON.stringify(this.state.photoSign) + "]}",
                                       (successData) => {
                                         this.setState({
                                           showCreditFinished: "block",
                                           isShowPhotoSign: "photo"
                  ...
                  <Button type="warning" size="large"
                          onClick={() => {
                            ...
                            if (this.state.isLookorAdd) {
                              //传递一个当前id。--确认修改
                              this.props.partyActions.postPartyInfo(this.state.clickId);
                            } else {
                              this.props.partyActions.postPartyInfo(this.props.partyData.form);
                            }
                          }}>
