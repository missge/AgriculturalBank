...
export default class Dialog extends Component {
  ...
  render(): React.Element<any> {
    ...
    return (
      <div>
        <Transition name={this.props.transition}>
          <View show={ visible }>
            <div
              ref="wrap"
              style={{ zIndex: 1013 }}
            ...
            >
              ...
              >
              {size === 'full' ? null: <div className="el-dialog__header_deco"/>}
                <div className="el-dialog__header">
                  <span className="el-dialog__title">{ title }</span>
                  {
                    showClose && (
                      <button type="button" className="el-dialog__headerbtn">
                        <i className="el-dialog__close mmspc-icon mmspc-icon-close" onClick={ e => this.close(e) }></i>
                      </button>
                    )
                  }
                </div>
