              ...
              currentView !== 'time' && (
                <div className="el-date-picker__header">
                  <button
                    ...
                    className="el-picker-panel__icon-btn el-date-picker__prev-btn mmspc-icon-d-arrow-left">
                  </button>
                  {
                    currentView === PICKER_VIEWS.DATE && (
                      <button
                        ...
                        className="el-picker-panel__icon-btn el-date-picker__prev-btn mmspc-icon-arrow-left">
                      </button>)
                  }
                  <span
                  ...
                  <button
                    ...
                    className="el-picker-panel__icon-btn el-date-picker__next-btn mmspc-icon-d-arrow-right">
                  </button>
                  {
                    currentView === PICKER_VIEWS.DATE && (
                      <button
                        ...
                        className="el-picker-panel__icon-btn el-date-picker__next-btn mmspc-icon-arrow-right">
                      </button>
                    )
                  }
                </div>
